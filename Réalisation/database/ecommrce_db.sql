...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=683203606ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=basket">`ecommerce_db`.`basket`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecommerce_db&table=items">`ecommerce_db`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=esmashop&table=basket">`esmashop`.`basket`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=esmashop&table=items">`esmashop`.`items`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=esmashop&table=users">`esmashop`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=esmashop&table=categories">`esmashop`.`categories`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="786072577752586a2448386e6434444c">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="ecommerce_db" targettable="items">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `ecommerce_db`.`items` WHERE `Item_ID` = 5</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `ecommerce_db`.`items` WHERE `Item_ID` = 5</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="basket">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `basket`</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM basket WHERE `basket`.`user_id` = 20;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="basket">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `basket` where id = 20;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="basket">
                            <div class="action_content">
...
ORDER BY `items`.`Item_ID` ASC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="items">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `items`  
ORDER BY `items`.`Item_ID`  DESC</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecommerce_db" targettable="items">
                            <div class="action_content">
...
ORDER BY `items`.`Item_ID`  DESC</span>
            ...
            Queried time
                            ...
                            <span class="query">DELETE FROM `basket` where user_id = 20;</span>
                        </div>
