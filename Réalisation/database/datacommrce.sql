...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2022 at 02:32 AM
...
INSERT INTO `basket` (`id`, `quantity`, `item_id`, `user_id`) VALUES
(1, 0, 5, 20),
(2, 0, 2, 20),
(3, 0, 2, 20);
...
--
ALTER TABLE `basket`
  ADD CONSTRAINT `item_link` FOREIGN KEY (`item_id`) REFERENCES `items` (`Item_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `user_link` FOREIGN KEY (`user_id`) REFERENCES `users` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE;
